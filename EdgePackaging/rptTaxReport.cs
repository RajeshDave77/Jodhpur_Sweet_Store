...
namespace EdgePackaging {
    ...
    public class rptTaxReport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EdgePackaging.rptTaxReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptTaxReport : Component, ICachedReport {
        
        public CachedrptTaxReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptTaxReport rpt = new rptTaxReport();
            rpt.Site = this.Site;
            return rpt;
        }
