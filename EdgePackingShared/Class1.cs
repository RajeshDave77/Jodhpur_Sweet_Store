  ...
  public  class database_admin
    {
        ...
        public SqlConnection con_admin = new SqlConnection( File.ReadAllText(Application.StartupPath + "//DataConnection.txt"));
      ...
      public void BeginTrans()
        {
            chk_connection();
            con_admin.Open();
          Trans = con_admin.BeginTransaction();
        }
      ...
      public void RollBack()
      {
        ...
        public void auto_fill(string qry, ComboBox combobox_name, string database)
        {
            ...
            adp.SelectCommand = new SqlCommand(qry, run_con);
            adp.Fill(ds, "tab");
        ...
        public void database_set(string database_name)
        {
            ...
            if (run_con.State == ConnectionState.Open)
            {
                run_con.Close();
            }
            run_con.Open();
            cmd.Connection = run_con;
        }
        ...
        public void suggest(string qry, ComboBox textboxname, string column)
        {
            chk_connection();
            con_admin.Open();
            cmd.Connection = con_admin;
